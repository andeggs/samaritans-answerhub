            ...
            <#else>
                <div class="row">
                    <div class="span12 text-center">
                        ...
                        Copyright &copy; 2010-15 <a href="http://dzone.com/corporate/about">DZone, Inc.</a> - All rights reserved.
                    </div>
                </div>
            </#if>
                ...
                <div class="row">
                    <div class="span12 text-center">
                        <p class="footer-copyright" style="font-size: 85%">
                            <a href="http://answerhub.com/?utm_source=appfooter&utm_medium=web&utm_campaign=Application%2BReferral%2B" style="color: #fff;"><img src="<@url path="/images/ah-logo-white.png"/>">
