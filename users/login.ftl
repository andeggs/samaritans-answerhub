...
<div class="login row-fluid">
    ...
    <#if authModeKeys?seq_contains("local")>
        <form class="form" action="<@spring.url "/j_spring_security_check" />" method="post">
            <div class="control-group">
                <div class="controls">
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-user"></i></span>
                        <input type="text" id="username" name="j_username" value="<#if lastUsername?? && RequestParameters.loginFail??><@teamhub.clean lastUsername/></#if>" placeholder="${usernamePlaceholder}"
            ...
            <div class="actions clearfix">
                ...
                <label class="keepMeLoggedIn checkbox pull-left">
                    <input name="_spring_security_remember_me" type="checkbox" value="true" checked="checked"
